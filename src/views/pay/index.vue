<template>
  <div class="pay">
    <van-nav-bar fixed left-arrow title="订单结算台" @click-left="$router.go(-1)"/>
    ...
    <div class="pay-list">
      <div class="list">
        <div class="goods-item">
          <div class="left">
            <img alt="" src="http://cba.itlike.com/public/uploads/10001/20230321/8f505c6c437fc3d4b4310b57b1567544.jpg"/>
          </div>
          <div class="right">
      ...
      <!-- 买家留言 -->
      <div class="buytips">
        <textarea id="" cols="30" name="" placeholder="选填：买家留言（50字内）" rows="10"></textarea>
      </div>
    </div>
