<template>
  <div class="pro-detail">
    <van-nav-bar fixed left-arrow title="商品详情页" @click-left="$router.go(-1)"/>
    ...
    <div class="comment">
      ...
      <div class="comment-list">
        <div v-for="item in commentList" :key="item.comment_id" class="comment-item">
          <div class="top">
...
export default {
  ...
  methods: {
    ...
    async getGoodsDetail () {
      const { data: { detail } } = await getGoodsDetailApi(this.goodsId)
      this.detail = detail
